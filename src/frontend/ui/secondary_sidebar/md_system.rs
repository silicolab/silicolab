...
// The compute-target picker and `remote_host_options` moved to the shared
// `frontend::ui::execution` module (reused by every task panel and Settings);
// this file reaches them via `use super::*`.
