...
pub fn command_catalog() -> String {
    [
        ...
        "  glycosylate --protein <#id|name> --iupac <iupac> --at <chain:resSeq> [--kind n|o] [--name <name>]",
        "                              Attach a glycan to a protein anchor residue (Asn for N-linked,",
        "                              Ser/Thr for O-linked), e.g. `glycosylate --protein active`",
        "                              `--iupac \"Man(b1-4)GlcNAc(b1-4)GlcNAc\" --at A:297 --kind n`.",
        "",
